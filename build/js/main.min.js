...
/* harmony import */ var _modules_initSlider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/initSlider */ "./js/modules/initSlider.js");
...
Object(_modules_initSlider__WEBPACK_IMPORTED_MODULE_3__["initSlider"])();
...
var initSlider = function initSlider() {
  ...
  var staffSlider = document.querySelector('.staff__slider');
  var offerSlider = document.querySelector('.offer__slider');

  if (projectsSlider) {
    var sliderProjects = new Swiper(projectsSlider, {
      slidesPerView: 1,
      slidesPerGroup: 1,
      speed: 500,
      effect: 'fade',
  ...
  if (staffSlider) {
    var sliderStaff = new Swiper(staffSlider, {
      slidesPerView: 1,
      slidesPerGroup: 1,
      speed: 500,
      effect: 'fade',
  ...
  if (offerSlider) {
    var sliderOffer = new Swiper(offerSlider, {
      slidesPerView: 1,
      slidesPerGroup: 1,
      speed: 500,
      effect: 'fade',
